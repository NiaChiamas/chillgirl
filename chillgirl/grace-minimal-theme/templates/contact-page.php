					...
					<div class="contact-page-content">
						...
						<?php
							...
							if(class_exists('acf')){
								...
								if(get_field('contact_hide_page_title') == ""){
							
									// check custom page title
									if(get_field('contact_custom_title') != ""){
									
										$contact_page_title = get_field('contact_custom_title');
									
									// default page title
									} else {
									
										$contact_page_title = get_the_title();
						...
						<?php if($contact_page_title_show == true){ ?>
							<h1 class="font-montserrat-reg page-heading"><?php echo esc_html($contact_page_title); ?></h1>
						<?php } ?>
